# analysis.py  (final with snippet support)
import re
import json
import time
import sqlite3
...
# ---------- CONFIG ----------
VT_API_KEY = None  # ضع مفتاح VirusTotal من env إذا توفر
    ...
    if msg.is_multipart():
        for part in msg.walk():
            ...
            if ctype == "text/plain":
                ...
                # إزالة التاجز للحصول على نص عادي
...
# ===== تحليل الكلمات المفتاحية + snippet =====
...
def run_analysis(file_path):
    ...
    keyword_details = analyze_keywords(body_text)  # full details
    keyword_findings = [k["keyword"] for k in keyword_details]  # فقط الكلمات
